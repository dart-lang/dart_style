...
void main() {
  ...
  group('fix', () {
    test('--fix applies all fixes', () async {
      var process = await runFormatter(['--fix', '--output=show']);
    ...
    test('--fix-named-default-separator', () async {
      var process = await runFormatter(
          ['--fix-named-default-separator', '--output=show']);
      process.stdin.writeln('foo({a:1}) {');
    ...
    test('--fix-optional-const', () async {
      var process =
          await runFormatter(['--fix-optional-const', '--output=show']);
      process.stdin.writeln('foo({a:1}) {');
    ...
    test('--fix-optional-new', () async {
      var process = await runFormatter(['--fix-optional-new', '--output=show']);
      process.stdin.writeln('foo({a:1}) {');
      process.stdin.writeln('  new Bar();}');
      await process.stdin.close();
